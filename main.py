...
MDNavigationLayout:
    ...
    MDNavigationDrawer:
        ...
        MDNavigationDrawerMenu:
            ...
            OneLineListItem:
                text: "All instuite notes "
                on_release: app.show_instuite_notes()
                
            OneLineListItem:
                text: "solve_for _other"
                on_release: app.show_motivation()                
...
<AIChatScreen>:
    ...
    MDBoxLayout:
        ...
        MDCard:
            size_hint: (0.99, 8)  # Increased height to 80% of the screen
            pos_hint: {"center_x": 0.5}
...
class StudentProductivityApp(MDApp):
    ...
    def show_instuite_notes(self):
        dialog = MDDialog(title="all facuilites notes ", text=" all notes of all instuites like Ak@sh,pw,@llen,u@cadmy your favourites teacher like P1,C1,Z3,C14,C6,C5,B3 ,C3  etc....  this features  coming soon.....", buttons=[MDRaisedButton(text="OK", on_release=lambda x: dialog.dismiss())])
        dialog.open()



    def show_motivation(self):
        dialog = MDDialog(title="DOUBT_KILLER", text="Solve Doubt of others student and earn digital coin converts to real coin ₹ # this features coming soon ,stay connected  ", buttons=[MDRaisedButton(text="OK", on_release=lambda x: dialog.dismiss())])
        dialog.open()

    def show_contact_dialog(self):
        dialog = MDDialog(
            title="Contact Owner",
            text="Email: on  studyonlyjnv@gmail.com they will definitely lishen you #royal_brother",
            buttons=[
